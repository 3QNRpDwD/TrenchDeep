...
impl crate::runtime::prepared::PreparedModel for MLP {
    ...
    fn execution_batch(&mut self, batch: &Self::Batch) -> MlResult<crate::runtime::prepared::PreparedBatch> {
    ...
    fn forward_inputs(&self, inputs: &crate::runtime::prepared::ExecutionInputs) -> MlResult<crate::runtime::prepared::ModelOutput> {
...
pub fn three_layer_model_prepare() -> MlResult<()> {
    ...
    let batch = mlp.execution_batch(&SupervisedBatch { inputs: data, targets: target })?;
