use super::service::{StepData, TrainingService, sample_count};
use super::*;
...
impl SupervisedTrainer {
    ...
    pub fn from_trainer(context: &ExecutionContext, trainer: Trainer) -> Self {
        Self {
            service: TrainingService::new(context, trainer),
        }
    }
    ...
    pub fn fit<M: SupervisedModel, I: IntoBatchLoader<Batch = SupervisedBatch>>(
        &self,
        model: &mut M,
        ...
        self.service.fit(
            ...
            |model, batch, epoch| {
                ...
                let (prediction, loss) = model.forward_loss(&batch.inputs, &batch.targets)?;
                Ok(StepData {
                    loss,
                    prediction: Some(prediction),
                    target: Some(batch.targets),
                    weight,
                    tokens: None,
                    lambda: None,
                })
    ...
    pub fn fit_loader<M: SupervisedModel, I: IntoBatchLoader<Batch = SupervisedBatch>>(
        &self,
        model: &mut M,
        optimizer: &mut dyn Optimizer,
        input: I,
        ...
        self.fit(model, optimizer, input, schedule)
    }
    pub fn fit_checkpointed<
        M: SupervisedModel + CheckpointableModel,
        I: IntoBatchLoader<Batch = SupervisedBatch>,
    >(
        &self,
        model: &mut M,
        optimizer: &mut dyn Optimizer,
    ...
    pub fn resume<M: SupervisedModel, I: IntoBatchLoader<Batch = SupervisedBatch>>(
        &self,
        _model: &mut M,
...
impl UnsupervisedTrainer {
    ...
    pub fn fit<M: UnsupervisedModel, I: IntoBatchLoader<Batch = UnsupervisedBatch>>(
        &self,
        model: &mut M,
        optimizer: &mut dyn Optimizer,
        input: I,
        ...
        self.service.fit(
            ...
            |model, batch, epoch| {
                ...
                let (prediction, loss) = model.forward_loss(&batch.samples)?;
                Ok(StepData {
                    loss,
                    prediction: Some(prediction),
                    target: None,
    ...
    pub fn fit_loader<M: UnsupervisedModel, I: IntoBatchLoader<Batch = UnsupervisedBatch>>(
        &self,
        model: &mut M,
        optimizer: &mut dyn Optimizer,
        input: I,
    ...
    pub fn resume<M: UnsupervisedModel, I: IntoBatchLoader<Batch = UnsupervisedBatch>>(
        &self,
        _model: &mut M,
        _optimizer: &mut dyn Optimizer,
        _input: I,
...
impl AutoregressiveTrainer {
    ...
    pub fn fit<M: AutoregressiveModel, I: IntoBatchLoader<Batch = AutoregressiveBatch>>(
        &self,
        model: &mut M,
        optimizer: &mut dyn Optimizer,
        input: I,
        ...
        self.service.fit(
            ...
            "autoregressive",
            |model, batch, epoch| {
                let (prediction, loss, tokens) = model.forward_loss(&batch.sequences)?;
                Ok(StepData {
                    loss,
                    prediction: Some(prediction),
                    target: None,
    ...
    pub fn fit_loader<M: AutoregressiveModel, I: IntoBatchLoader<Batch = AutoregressiveBatch>>(
        &self,
        model: &mut M,
        optimizer: &mut dyn Optimizer,
        input: I,
    ...
    pub fn resume<M: AutoregressiveModel, I: IntoBatchLoader<Batch = AutoregressiveBatch>>(
        &self,
        _model: &mut M,
        _optimizer: &mut dyn Optimizer,
        _input: I,
...
impl SemiSupervisedTrainer {
    ...
    pub fn fit<M: SemiSupervisedModel, I: IntoBatchLoader<Batch = SemiSupervisedBatch>>(
        &self,
        model: &mut M,
        optimizer: &mut dyn Optimizer,
        input: I,
        ...
        self.service.fit(
            ...
            |model, batch, epoch| {
                ...
                Ok(StepData {
                    loss,
                    prediction: Some(prediction),
                    target: Some(batch.labeled_targets),
                    weight,
                    tokens: None,
                    lambda: Some(lambda),
                })
    ...
    pub fn fit_loader<M: SemiSupervisedModel, I: IntoBatchLoader<Batch = SemiSupervisedBatch>>(
        &self,
        model: &mut M,
        optimizer: &mut dyn Optimizer,
        input: I,
    ...
    pub fn resume<M: SemiSupervisedModel, I: IntoBatchLoader<Batch = SemiSupervisedBatch>>(
        &self,
        _model: &mut M,
        _optimizer: &mut dyn Optimizer,
        _input: I,
