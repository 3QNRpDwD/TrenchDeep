...
pub mod config;
#[path = "legacy_metric_hook.rs"]
pub mod metric_hook;
#[path = "legacy_metrics.rs"]
pub mod metrics;
#[path = "legacy_convergence.rs"]
pub mod convergence;
#[path = "epoch_loop.rs"]
pub mod epoch_loop;
#[path = "legacy_runtime.rs"]
pub mod runtime;
#[path = "legacy_observer.rs"]
pub mod observer;
#[path = "debug_trace.rs"]
mod debug_trace;
...
impl TrainerCore {
    ...
    #[cfg(feature = "enableVisualization")]
    pub(crate) fn requested_capture_profile(&self, context: &BatchStartContext) -> Option<crate::legacy::visualization::CaptureProfile> {
        self.observers.borrow().iter().filter_map(|observer| observer.capture_profile(context)).max()
    }

    #[cfg(feature = "enableVisualization")]
    pub(crate) fn deliver_graph_snapshot(&self, context: &BatchStartContext, snapshot: crate::legacy::visualization::GraphSnapshot) {
