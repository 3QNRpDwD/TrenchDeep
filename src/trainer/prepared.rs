...
impl Trainer<Prepared> {
    ...
    where M: TrainableModel, O: PreparedObjective<M>, I: IntoBatchLoader<Batch = O::Batch> {
    ...
    where M: TrainableModel + CheckpointableModel, O: PreparedObjective<M>, I: IntoBatchLoader<Batch = O::Batch> {
