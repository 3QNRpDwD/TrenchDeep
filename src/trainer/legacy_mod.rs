...
#[path = "supervised.rs"]
pub mod supervised;
#[path = "unsupervised.rs"]
pub mod unsupervised;
#[path = "semi_supervised.rs"]
pub mod semi_supervised;
#[path = "legacy_reinforcement.rs"]
pub mod reinforcement;
#[path = "autoregressive.rs"]
pub mod autoregressive;
#[path = "data/legacy_mod.rs"]
pub mod data;
#[path = "legacy_progress.rs"]
...
pub(crate) use crate::legacy::{MlError, MlResult};
pub(crate) use crate::legacy::nn::Parameter;
pub(crate) use crate::legacy::tensor::TensorBase;
// ────────────────────────────────────────────────────────────────────────────
// Trainer — 범용 팩토리
// ────────────────────────────────────────────────────────────────────────────
...
#[cfg(test)]
#[path = "../tests/trainer/legacy_mod_preset_tests.rs"]
mod preset_tests;
