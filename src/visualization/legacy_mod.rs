...
mod tests {
    ...
    fn captured_add(profile: CaptureProfile, backward: bool) -> crate::legacy::MlResult<GraphSnapshot> {
    ...
    #[test]
    fn inactive_recording_skips_sidecar_and_statistics() -> crate::legacy::MlResult<()> {
    ...
    #[test]
    fn profiles_control_statistics_and_backward_stats_are_retained() -> crate::legacy::MlResult<()> {
    ...
    #[test]
    fn snapshot_is_owned_and_schema_matches_dot_ids() -> crate::legacy::MlResult<()> {
    ...
    #[test]
    fn file_writer_keeps_dot_and_json_when_graphviz_is_missing() -> crate::legacy::MlResult<()> {
    ...
    fn capture_disabled_micro_benchmark() -> crate::legacy::MlResult<()> {
