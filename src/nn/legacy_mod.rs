    ...
    ($layer:ty, $type_name:expr, [$($param:ident),+], |$s:ident| $config:expr) => {
        impl $layer {
            ...
            fn _load_state(&mut self, state: &LayerState) -> MlResult<()> {
                ...
                $(
                    let p = crate::legacy::nn::checkpoint::find_param(&state.params, stringify!($param))?;
                    crate::legacy::nn::checkpoint::validate_shape(p, self.$param.tensor().shape())?;
...
macro_rules! variable {
    ($vec:expr) => {
        crate::legacy::nn::Variable::new(crate::legacy::tensor::Tensor::new($vec))
    };

    ($data:expr, $shape:expr) => {
        crate::legacy::nn::Variable::new(crate::legacy::tensor::Tensor::from_vec($data, $shape).unwrap())
    };
    ...
    ($data:expr, $shape:expr, $label:expr) => {
        {
            ...
            {
                crate::legacy::nn::Variable::with_label(crate::legacy::tensor::Tensor::from_vec($data, $shape).unwrap(), $label)
            }
...
///
/// [`trainer::SupervisedModel`]: crate::legacy::trainer::SupervisedModel
/// [`trainer::SupervisedTrainer`]: crate::legacy::trainer::SupervisedTrainer
/// [`trainer::UnsupervisedModel`]: crate::legacy::trainer::UnsupervisedModel
/// [`trainer::UnsupervisedTrainer`]: crate::legacy::trainer::UnsupervisedTrainer
/// [`trainer::SemiSupervisedModel`]: crate::legacy::trainer::SemiSupervisedModel
/// [`trainer::SemiSupervisedTrainer`]: crate::legacy::trainer::SemiSupervisedTrainer
/// [`trainer::RLModel`]: crate::legacy::trainer::RLModel
/// [`trainer::Environment`]: crate::legacy::trainer::Environment
/// [`trainer::RLTrainer`]: crate::legacy::trainer::RLTrainer
pub trait Model: crate::legacy::trainer::TrainableModel + crate::legacy::trainer::CheckpointableModel {
...
pub struct Variable {
    ...
    #[cfg(feature = "enableVisualization")]
    node_type: Option<crate::legacy::visualization::NodeRole>,
    tensor: Tensor,
