...
//             .add_layer(Linear::new(n_input, n_hidden, "input_linear_1").unwrap())
//             .add_layer(crate::nn::activation::ReLULayer::new("hidden_relu"))
//             .add_layer(Linear::new(n_hidden, n_output, "hidden_linear_2").unwrap());
//             // .add_layer(crate::nn::activation::SoftmaxLayer::new("output_softmax"));
// 
